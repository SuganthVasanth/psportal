                                    ...
                                    {displayLeaves.map((leave) => (
                                        <tr key={leave.id} onClick={() => openDetailsModal(leave)} className="leave-row-clickable">
                                            ...
                                            <td className="leave-actions-cell" onClick={(e) => e.stopPropagation()}>
                                                {leave.status === "Pending" &&
                                                    (!leave.mentorApproval || leave.mentorApproval.status === "Pending") &&
                                                    (!leave.wardenApproval || leave.wardenApproval.status === "Pending") && (
                                                        <button
                                                            type="button"
                    ...
                    <div className="leave-details-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="leave-details-body">
                            ...
                            {selectedLeave.status === "Pending" &&
                                (!selectedLeave.mentorApproval || selectedLeave.mentorApproval.status === "Pending") &&
                                (!selectedLeave.wardenApproval || selectedLeave.wardenApproval.status === "Pending") && (
