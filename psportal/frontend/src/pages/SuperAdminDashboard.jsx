        ...
        <main className="sa-main">
          ...
          {activeSub === "question-banks" && (
            <div className="dashboard-card">
              ...
              {questionBankSubmissions.filter((s) => !questionBankFilterCourse || s.course_id === questionBankFilterCourse).length === 0 && (
                <p className="sa-muted">No question bank submissions yet.</p>
              )}
            </div>
          )}
          ...
          {activeSub === "code-access" && (
            <div className="dashboard-card">
              ...
              <p className="card-subtitle">Assign courses to technical faculty so they appear in their user dashboard.</p>
              ...
              <table className="sa-table">
                ...
                <tbody>
                  {facultyAssignments.map((a) => {
                    const displayName = a.user_name || a.user_email || a.user_id;
                    return (
                    <tr key={a.id}>
                      <td>
                        <button
              ...
              {facultyAssignments.length === 0 && <p className="sa-muted">No assignments yet.</p>}
              <ChatModal
                open={chatOpen}
